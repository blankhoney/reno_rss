...
| A-06 | IN_PROGRESS | Chromium 76/76, Firefox 35/35, WebKit 35/35, iPhone WebKit 29/29; state matrix and semantic audit now run cross-engine; Scan/Focus/Keep reflow green at 320–1440px in Chromium/Firefox/WebKit; full suite and cross-engine selection/input pairwise matrix remain |
