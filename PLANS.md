...
| A-06 | IN_PROGRESS | Chromium 79/79, Firefox 44/44, WebKit 43/43, iPhone WebKit 29/29; state matrix, semantic audit, annotation recovery, error/retry, and state language now run cross-engine; Scan/Focus/Keep reflow green at 320–1440px; full suite and cross-engine selection/input pairwise matrix remain |
