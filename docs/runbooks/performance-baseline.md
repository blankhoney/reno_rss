...
4. Confirm the resulting canonical-main run completed successfully and uploaded `db-postgres-performance-baseline-main` with an actual REST `expires_at` and digest.
