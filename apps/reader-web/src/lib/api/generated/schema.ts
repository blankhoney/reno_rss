...
export interface paths {
    ...
    "/api/articles/stats": {
        ...
        /** Article Stats */
        get: operations["article_stats_api_articles_stats_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/annotations/review": {
         ...
         * @description Private spaced-review queue: only items due now, ordered by due time.
         */
    ...
    "/api/annotations/{annotation_id}/review": {
        ...
        /**
         * Review Annotation
         * @description Advance SM-2 lite interval after a remember / forget response.
         */
        post: operations["review_annotation_api_annotations__annotation_id__review_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/articles/{article_id}/translate": {
        ...
        get?: never;
        put?: never;
        /** Enqueue Translate Article Job */
        post: operations["enqueue_translate_article_job_api_articles__article_id__translate_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/briefs/latest": {
        ...
        /** Latest Brief */
        get: operations["latest_brief_api_briefs_latest_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/clusters/latest": {
        ...
        /** Latest Clusters */
        get: operations["latest_clusters_api_clusters_latest_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/research/jobs": {
        ...
        post: operations["enqueue_research_job_api_research_jobs_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/research/jobs/{job_id}": {
        ...
        /**
         * Get Research Job
         * @description Thin alias over /api/jobs/{id}; only returns research_brief jobs owned/visible to the user.
         */
        get: operations["get_research_job_api_research_jobs__job_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/themes/latest": {
        ...
        /** Latest Themes */
        get: operations["latest_themes_api_themes_latest_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/saved-searches": {
        ...
        put: operations["replace_saved_searches_api_saved_searches_put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
...
export interface components {
    schemas: {
        ...
        /** ReplaceSavedSearchesRequest */
        ReplaceSavedSearchesRequest: {
            /** Items */
            items?: components["schemas"]["SavedSearchItem"][];
        };
        /** ResearchJobRequest */
        ResearchJobRequest: {
            /**
...
export interface operations {
    ...
    article_stats_api_articles_stats_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    review_annotation_api_annotations__annotation_id__review_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    enqueue_translate_article_job_api_articles__article_id__translate_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    latest_brief_api_briefs_latest_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    latest_clusters_api_clusters_latest_get: {
        parameters: {
            query?: {
                limit?: number;
            };
    ...
    put_rules_api_rules_put: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RulesPutRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    enqueue_research_job_api_research_jobs_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_research_job_api_research_jobs__job_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    latest_themes_api_themes_latest_get: {
        parameters: {
            query?: {
                limit?: number;
                max_themes?: number;
    ...
    replace_saved_searches_api_saved_searches_put: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
