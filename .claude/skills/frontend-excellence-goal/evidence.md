...
| Verified HEAD | `dec47f67d9aaa0c7c87c5c3536e0a86feb15662c` at start; uncommitted Wave 0 changes follow |
...
| C-02 mobile stacking conflict | Pending | |
| C-03 responsive mode collision | Pending | |
| C-04 keyboard scope | Pending | |
