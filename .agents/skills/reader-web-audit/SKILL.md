...
2. `GOAL.md`
3. `PLANS.md`
4. Relevant current source/tests

Treat historical files under `.agents/skills/frontend-excellence-goal/`, `docs/superpowers/`, and old evidence ledgers as context, not authority. If they conflict with the root files or current code, report the drift instead of following the historical snapshot.
